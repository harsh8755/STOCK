<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="CategoryMaster.aspx.cs" Inherits="Masters_CategoryMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
            ...
            <div class="col-md-9">
              <div class="form-group">
                  <label for="exampleInputEmail1">Enter Category Name</label>
                        <asp:TextBox ID="txtCategoryName" runat="server" CssClass="form-control" placeholder="Enter Category Name" MaxLength="50" TabIndex="1"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCategoryName" ErrorMessage="Please Enter Category name" Display="Dynamic" ValidationGroup="Category" CssClass="text-red"></asp:RequiredFieldValidator> </div>
       ...
       <div class="box-footer">
               <asp:Button ID="cmdSubmit" runat="server" Text="Submit" CssClass="btn btn-primary" ValidationGroup="Category" TabIndex="2" OnClick="cmdSubmit_Click" />  <asp:Button ID="cmdUpdate" runat="server" Text="Update"  TabIndex="2" CssClass="btn btn-primary" ValidationGroup="Category" Visible="false" OnClick="cmdUpdate_Click" /> <asp:Button ID="cmdClear" runat="server" Text="Clear" CssClass="btn btn-primary"  TabIndex="4" OnClick="cmdClear_Click"/>
             <br />
 ...
 <br />
            ...
            <asp:GridView ID="grdCategory" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdCategory_PageIndexChanging" PagerSettings-Mode="NumericFirstLast"
         AutoGenerateColumns="False"  ShowFooter="false"
   CssClass="table table-bordered table-striped"  DataKeyNames="category_id" EmptyDataText="No Record Found" OnRowCommand="grdCategory_RowCommand" OnRowDataBound="grdCategory_RowDataBound"  OnRowDeleting="grdCategory_RowDeleting"  OnRowUpdating="grdCategory_RowUpdating"   
         >
